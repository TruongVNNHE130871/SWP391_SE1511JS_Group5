 ...
 * @author VinhNT
 */
public class AddToCartFromProductDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("username") == null) {
            ...
            if (request.getParameter("idProduct") != null) {
                ...
                response.sendRedirect(request.getContextPath() + "/ProductDetailController?idProduct=" + id);
            } else {
